...
public class TeacherLogin extends Fragment implements View.OnClickListener {
    ...
    EditText teacherId,teacherAssword;
    Button loginbutton;
    private SharedPreferences settings;
    String weburl= "https://192.168.225.38/connection/teacherLogin.php";;
    private String mail="";
    private String pass="";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        teacherId=view.findViewById(R.id.adminId);
        teacherAssword=view.findViewById(R.id.adminPassword);
    ...
    public void getData()
    {
        ...
        mail=teacherId.getText().toString();


        pass=teacherAssword.getText().toString();
    ...
    public void callVolley()
    {
        ...
        Log.d("My_log","inside volley teacher");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,weburl,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("teacher_mail", mail);
                params.put("teacher_password", pass);
                return params;
            }
        };
    ...
    public void onClick(View v) {
        ...
        if (!inputManager.isAcceptingText())
            inputManager.hideSoftInputFromWindow(teacherId.getWindowToken(),
